# Geochronology Checklist

Source: `data/Laurentia_poles.csv`

This checklist mirrors the compilation order in the CSV and includes 99 pole entries. In VS Code, markdown task boxes can be checked off manually as you review each pole's geochronology.
...
- [ ] Freda Sandstone (RESULT# 2051; nominal age 1075 Ma)
...
- [x] St.Francois Mountains Acidic Rocks (RESULT# 8932; nominal age 1476 Ma)
