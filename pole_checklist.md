...
Source: `data/Laurentia_poles.csv` (compilation order). The legacy single Freda Sandstone entry is shown here as two poles — Lower Freda and Upper Freda — so this table has 101 rows.

Build-status tracker for each Laurentia pole. A ✓ marks a completed stage; a blank cell marks work still to do.

- geochronology verified — the pole's age has been checked against primary geochronology references (carried over from the prior geochronology checklist).
- notebook developed — a pole-assessment notebook exists in `pole_notebooks/`.
...
|---|:---:|:---:|:---:|:---:|
| Sept-Iles Layered Intrusion (RESULT# 1752; nominal age 565 Ma) | ✓ | ✓ | ✓ |  |
| Catoctin Basalts (RESULT# 7474; nominal age 568 Ma) | ✓ | ✓ | ✓ |  |
| Callander Alkaline Complex (RESULT# 6458; nominal age 575 Ma) | ✓ | ✓ | ✓ |  |
| Baie des Moutons A (RESULT# 9364; nominal age 583 Ma) | ✓ | ✓ | ✓ |  |
| Baie des Moutons B (RESULT# 9365; nominal age 583 Ma) | ✓ | ✓ | ✓ |  |
| Long Range Dykes (RESULT# 6934-6936; nominal age 615 Ma) | ✓ | ✓ | ✓ |  |
| Franklin event grand mean (RESULT# new; nominal age 719 Ma) |  | ✓ | ✓ |  |
| Kwagunt Formation (RESULT# 9981; nominal age 751 Ma) |  | ✓ | ✓ |  |
| Uinta Mountain Group (RESULT# 9290; nominal age 750 Ma) | ✓ | ✓ | ✓ |  |
| Gunbarrel LIP (nominal age 780 Ma) |  | ✓ | ✓ |  |
| Adirondack metamorphic anorthosite (nominal age 887 Ma) |  | ✓ | ✓ |  |
...
| Schroeder Lutsen Basalts (RESULT# 9915; nominal age 1090 Ma) |  | ✓ | ✓ |  |
| Cardenas Basalts and Intrusions (RESULT# 9073; nominal age 1090 Ma) |  | ✓ | ✓ | ✓ |
| Chengwatana Volcanics (RESULT# 8163; nominal age 1095 Ma) |  | ✓ |  |  |
| Portage Lake Volcanics (RESULT# 9507; nominal age 1092 Ma) |  | ✓ | ✓ |  |
| North Shore lavas -N (RESULT# 9856; nominal age 1095 Ma) |  | ✓ | ✓ |  |
| Uppermost Mamainse Point volcanics -N (RESULT# 9513; nominal age 1094 Ma) |  | ✓ | ✓ |  |
| Mamainse Point volcanics -C (lower N, upper R) (RESULT# 9512; nominal age 1100 Ma) |  | ✓ | ✓ |  |
| Upper third Osler volcanics -R (RESULT# 9514; nominal age 1105 Ma) |  | ✓ | ✓ |  |
| Lower Mamainse Point volcanics -R2 (RESULT# 9511; nominal age 1105 Ma) |  | ✓ | ✓ |  |
| Middle third Osler volcanics -R (RESULT# 10017; nominal age 1107 Ma) |  | ✓ | ✓ |  |
| Colwell Complex (RESULT# 9838; nominal age 1107 Ma) |  | ✓ |  |  |
| Lower third Osler volcanics -R (RESULT# 9515; nominal age 1108 Ma) |  | ✓ | ✓ |  |
| Lowermost Mamainse Point volcanics -R1 (RESULT# 9510; nominal age 1109 Ma) |  | ✓ | ✓ |  |
...
| Pole | geochronology verified | notebook developed | MagIC developed | MagIC contributed |
|---|:---:|:---:|:---:|:---:|
| MEAN Stoer Group (RESULT# NEW; nominal age 1199 Ma) |  | ✓ |  |  |
...
| Pole | geochronology verified | notebook developed | MagIC developed | MagIC contributed |
|---|:---:|:---:|:---:|:---:|
| Otto Stock Dykes and Aureole (RESULT# 2629; nominal age updated from 2676 Ma to 2680 Ma) | ✓ | ✓ | ✓ |  |
...
| SENNETERRE (RESULT# B+93; nominal age 2216 Ma) | ✓ | ✓ |  |  |
...
| Pole | geochronology verified | notebook developed | MagIC developed | MagIC contributed |
|---|:---:|:---:|:---:|:---:|
| MARATHON N (RESULT# H+08; nominal age 2124 Ma) | ✓ | ✓ |  |  |
| MARATHON R (RESULT# H+08; nominal age 2104 Ma) | ✓ | ✓ |  |  |
| CAUCHON LAKE (RESULT# 8548; nominal age 2091 Ma) | ✓ | ✓ |  |  |
...
| Pole | geochronology verified | notebook developed | MagIC developed | MagIC contributed |
|---|:---:|:---:|:---:|:---:|
| Stillwater Complex - C2 (RESULT# 9917; `nominal age updated from 2705 Ma to 2709 Ma`) | ✓ | ✓ |  |  |
...
| Elbow Creek dikes (nominal age 2480 Ma) | ✓ |  |  |  |
